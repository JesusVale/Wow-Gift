export const headerSignIn = `<link rel="stylesheet" href="/components/header-component/header.css">
<header class="header">
    <a href="/">
    ...
    <form action="/search" class="buscador">
        <input type="search" name="k" placeholder="Buscar Artículo" class="buscador__input">
    ...
    <div class="header__enter">
        <nav class="menu-cuenta">
            ...
            <ul class="menu-cuenta__list">
                <li class="menu-cuenta__item">
                    <a href="/shopping" class="menu-cuenta__link">
                ...
                <li class="menu-cuenta__item">
                    <a href="/articles" class="menu-cuenta__link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-store" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <a href="/shopping" class="header__link">Mis Compras</a>
